...
class HomeScreen extends StatelessWidget {
  static final LatLng companyLatLng = LatLng(37.566535, 126.977969);

  static final Marker marker =
      Marker(markerId: MarkerId('company'), position: companyLatLng);

  static final Circle circle = Circle(
    circleId: CircleId('checkAbleCircle'),
                      ...
                      children: [
                        ...
                        ElevatedButton(
                            onPressed: () async {
                              ...
                              bool canCheck = distance < 100; // 100이내면 체크 가능
